...
class HUDStatusViewTheme {
    static let imageInsets: UIEdgeInsets = UIEdgeInsets(top: 32, left: 32, bottom: 32, right: 32)
    static let textInsets: UIEdgeInsets = UIEdgeInsets(top: 32, left: 32, bottom: 16, right: 32)
